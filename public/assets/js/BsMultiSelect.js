...
(function (global, factory) {
    typeof exports === "object" && typeof module !== "undefined"
        ...
        : ((global =
          ...
          (global.dashboardcode = factory(global.Popper)));
    ...
    function addToJQueryPrototype(pluginName, createPlugin, $) {
        ...
        if (firstCharLower == firstChar) {
            throw new Error(
                "Plugin name '" +
                    pluginName +
                    "' should be started from upper case char"
            );
        }
        ...
        function createInstance(options, e, $e) {
            var optionsRef =
                typeof options === "object" || options instanceof Function
                    ? options
                    : null;
        ...
        function prototypable(options) {
            ...
            if (output.length == 0) return this;
            else if (output.length == 1) return output[0];
            else return output;
        }
            ...
            sources.forEach(function (s) {
                for (var _property in s) {
                    ...
                    if (!(_v === null || _v === undefined))
                        destination[_property] = _v;
                    else if (destination.hasOwnProperty(_property)) {
    ...
    function createCss(stylings1, stylings2) {
        ...
        for (var property in stylings1) {
            ...
            if (param2 === undefined) destination[property] = Styling(param1);
            else {
        ...
        if (stylings2)
            for (var _property in stylings2) {
                if (!stylings1[_property])
    ...
    function extendCss(stylings1, stylings2) {
        for (var property in stylings2) {
            ...
            var param1 = stylings1[property];
            if (param1 === undefined) stylings1[property] = Styling(param2);
            else {
    ...
    function PickDomFactory(css, createElementAspect, dataWrap) {
        return {
            create: function create(pick) {
                ...
                var pickContentElement =
                    createElementAspect.createElement("SPAN");
                ...
                pickDomManagerHandlers.updateData = function () {
                    ...
                    pickContentElement.textContent = dataWrap.getText(
                        wrap.option
                    );
                };
    ...
    function buildDom(choiceElement, choiceDom, createElementAspect, css) {
        createElementAspect.createElementFromHtml(
            choiceElement,
    ...
    function buidDisabled(choiceDom, choiceDomManagerHandlers, css, wrap) {
        var choiceDisabledToggle = toggleStyling(
            choiceDom.choiceElement,
            css.choice_disabled
        );
        var choiceCheckBoxDisabledToggle = toggleStyling(
            choiceDom.choiceCheckBoxElement,
            css.choiceCheckBox_disabled
        );
        var choiceLabelDisabledToggle = toggleStyling(
            choiceDom.choiceLabelElement,
            css.choiceLabel_disabled
        );
        var choiceCursorDisabledToggle = toggleStyling(
            choiceDom.choiceElement,
            {
                classes: [],
                styles: {
        ...
        var updateDisabled = function updateDisabled() {
            ...
            var isCheckBoxDisabled =
                wrap.isOptionDisabled && !wrap.isOptionSelected;
    ...
    function ChoiceDomFactory(css, createElementAspect, dataWrap) {
        ...
        return {
            create: function create(choice) {
                ...
                var choiceHoverToggle = toggleStyling(
                    choiceElement,
                    function () {
                        return wrap.isOptionDisabled === true &&
                            css.choice_disabled_hover &&
                            wrap.isOptionSelected === false
                            ? css.choice_disabled_hover
                            : css.choice_hover;
                    }
                ...
                var choiceSelectedToggle = toggleStyling(
                    choiceElement,
                    css.choice_selected
                );
                ...
                var updateSelected = function updateSelected() {
                    ...
                    choiceDom.choiceCheckBoxElement.checked =
                        wrap.isOptionSelected;
                ...
                choiceDomManagerHandlers.updateData = function () {
                    choiceDom.choiceLabelElement.textContent = dataWrap.getText(
                        wrap.option
                    );
        ...
        return {
            createStaticDom: function createStaticDom() {
                ...
                if (initialElement.tagName == "DIV") {
                    ...
                    picksElement = findDirectChildByTagName(
                        containerElement,
                        "UL"
                    );
                    ...
                    throw new Error(
                        "BsMultiSelect: INPUT element is not supported"
                    );
                }
                ...
                staticDom.isDisposablePicksElementFlag =
                ...
                return {
                    staticManager: {
                        appendToContainer: function appendToContainer() {
                            ...
                            picksDom.pickFilterElement.appendChild(
                                filterDom.filterInputElement
                            );
                            picksDom.picksElement.appendChild(
                                picksDom.pickFilterElement
                            );
    ...
    function PicksDomFactory(staticDom) {
        return {
            create: function create() {
                ...
                var disableToggleStyling = toggleStyling(
                    picksElement,
                    css.picks_disabled
                );
                var focusToggleStyling = toggleStyling(
                    picksElement,
                    css.picks_focus
                );
                var isFocusIn = false;
                return {
                    ...
                    createPickElement: function createPickElement() {
                        var pickElement =
                            createElementAspect.createElement("LI");
                        addStyling(pickElement, css.pick);
                        return {
                            pickElement: pickElement,
                            attach: function attach(beforeElement) {
                                return picksElement.insertBefore(
                                    pickElement,
                                    beforeElement != null
                                        ? beforeElement
                                        : pickFilterElement
                    ...
                    dispose: function dispose() {
                        if (!isDisposablePicksElementFlag) {
                            ...
                            if (pickFilterElement.parentNode)
                                pickFilterElement.parentNode.removeChild(
                                    pickFilterElement
                                );
                        }
                    },
    ...
    function FilterDomFactory(staticDom) {
        return {
            create: function create() {
                var isDisposablePicksElementFlag =
                        staticDom.isDisposablePicksElementFlag,
                    css = staticDom.css,
                    createElementAspect = staticDom.createElementAspect;
                var filterInputElement =
                    createElementAspect.createElement("INPUT");
                ...
                return {
                    ...
                    setWidth: function setWidth(text) {
                        filterInputElement.style.width =
                            text.length * 1.3 + 2 + "ch";
                    },
                    ...
                    dispose: function dispose() {
                        ...
                        if (!isDisposablePicksElementFlag) {
                            if (filterInputElement.parentNode)
                                filterInputElement.parentNode.removeChild(
                                    filterInputElement
                                );
                        }
                    },
        ...
        return {
            create: function create() {
                ...
                var choicesListElement =
                    createElementAspect.createElement("UL");
                    ...
                    createChoiceElement: function createChoiceElement() {
                        ...
                        return {
                            ...
                            setVisible: function setVisible(isVisible) {
                                return (choiceElement.style.display = isVisible
                                    ? "block"
                                    : "none");
                            },
                            attach: function attach(beforeElement) {
                                return choicesListElement.insertBefore(
                                    choiceElement,
                                    beforeElement
                                );
                            },
                            detach: function detach() {
                                return choicesListElement.removeChild(
                                    choiceElement
                                );
                            },
                        };
    ...
    function BuildAndAttachChoiceAspect(produceChoiceAspect) {
        return {
            buildAndAttachChoice: function buildAndAttachChoice(
                wrap,
                getNextElement
            ) {
                produceChoiceAspect.produceChoice(wrap);
                wrap.choice.choiceDomManagerHandlers.attach(
                    getNextElement == null ? void 0 : getNextElement()
                );
            },
        };
    }
    ...
    function InputAspect(filterDom, filterManagerAspect) {
        return {
            ...
            processInput: function processInput() {
                ...
                if (!isEmpty) {
                    if (
                        filterManagerAspect.getNavigateManager().getCount() == 1
                    ) {
                        // todo: move exact match to filterManager
                        var fullMatchWrap = filterManagerAspect
                            .getNavigateManager()
                            .getHead();
    ...
    function MultiSelectInlineLayoutAspect(
        environment,
        filterDom,
        choicesDom,
        ...
        var choicesElementMousedownEventTumbler = EventTumbler(
            choicesElement,
            "mousedown",
            skipoutMousedown
        );
        var documentMouseupEventTumbler = EventTumbler(
            document,
            "mouseup",
            documentMouseup
        );
        ...
        var documentMouseup = function documentMouseup(event) {
            ...
            if (choicesElement == event.target)
                filterDom.setFocus(); // if click outside container - close dropdown
            else if (
                !containsAndSelf(choicesElement, event.target) &&
                !picksElementAspect.containsAndSelf(event.target)
            ) {
                resetLayoutAspect.resetLayout();
        ...
        var mouseOverToHoveredAndReset = function mouseOverToHoveredAndReset(
            wrap
        ) {
        ...
        function adoptChoiceElement(wrap) {
            ...
            var onChoiceElementMouseover = function onChoiceElementMouseover() {
                if (eventLoopFlag.get()) {
                    resetMouseCandidateChoice();
                    mouseCandidateEventBinder.bind(
                        choiceElement,
                        "mousemove",
                        function () {
            ...
            var onChoiceElementMouseleave =
                function onChoiceElementMouseleave() {
                    if (!eventLoopFlag.get()) {
                        hoveredChoiceAspect.resetHoveredChoice();
                    }
                };
        ...
        function afterInput() {
            var visibleCount = filterManagerAspect
                .getNavigateManager()
                .getCount();
        ...
        var onKeyUp = function onKeyUp(event) {
            ...
            if (
                ...
                if (choicesVisibilityAspect.isChoicesVisible()) {
                    ...
                    if (
                        filterManagerAspect.getNavigateManager().getCount() > 0
                    ) {
                        showChoices();
                    }
                }
            ...
            layout: function layout() {
                ...
                filterDom.onInput(function () {
                    var _inputAspect$processI = inputAspect.processInput(),
                        filterInputValue =
                            _inputAspect$processI.filterInputValue,
                        isEmpty = _inputAspect$processI.isEmpty;

                    if (isEmpty) filterManagerAspect.processEmptyInput();
                ...
                produceChoiceAspect.produceChoice = function (wrap) {
                    ...
                    wrap.choice.choiceDomManagerHandlers.detach = composeSync(
                    ...
                    wrap.choice.choiсeClick = composeSync(
                        wrap.choice.choiсeClick,
                        function () {
    ...
    function CountableChoicesListInsertAspect(
        wrapsCollection,
        countableChoicesList
    ) {
        return {
            countableChoicesListInsert: function countableChoicesListInsert(
                wrap,
                key
            ) {
    ...
    function PicksElementAspect(picksElement) {
        ...
        return {
            ...
            onClick: function onClick(handler) {
                componentDisabledEventBinder.bind(
                    picksElement,
                    "click",
                    handler
                );
            ...
            onMousedown: function onMousedown(handler) {
                skipoutAndResetMousedownEventBinder.bind(
                    picksElement,
                    "mousedown",
                    handler
                );
    ...
    function AfterInputAspect(
        ...
        return {
            visible: function visible(showChoices, visibleCount) {
                ...
                if (visibleCount == 1) {
                    navigateAspect.hoverIn(
                        filterManagerAspect.getNavigateManager().getHead()
                    );
                } else {
    ...
    function ShowErrorAspect(staticDom) {
        return {
            showError: function showError(error) {
                ...
                initialElement.parentNode.insertBefore(
                    errorElement,
                    initialElement.nextSibling
                );
            },
        };
    }

    function BsMultiSelect$1(
        initialElement,
        environment,
        pluginManager,
        configuration
        ...
        var createElementAspect = CreateElementAspect(
            function (name) {
            ...
            function (element, html) {
                var newElement =
                    new environment.window.DOMParser().parseFromString(
                        html,
                        "text/html"
                    ).body.children[0];
        ...
        var pickDomFactory = PickDomFactory(
            css,
            staticDom.createElementAspect,
            dataWrap
        ); // overrided in CustomPickStylingsPlugin, DisableComponentPlugin

        var choiceDomFactory = ChoiceDomFactory(
            css,
            staticDom.createElementAspect,
            dataWrap
        ); // overrided in CustomChoicesStylingsPlugin, HighlightPlugin
    ...
    function BsMultiSelectImpl(
        ...
        var onChangeAspect = OnChangeAspect(
            staticDom,
        ...
        var picksList = List();
        var produceChoiceAspect = ProduceChoiceAspect(
            choicesDom,
            choiceDomFactory
        );
        var wrapsCollection = ArrayFacade();
        var countableChoicesList = DoublyLinkedList(
            function (wrap) {
        ...
        var countableChoicesListInsertAspect = CountableChoicesListInsertAspect(
            wrapsCollection,
            countableChoicesList
        );
        var wraps = Wraps(
            ...
            function (w, key) {
                return countableChoicesListInsertAspect.countableChoicesListInsert(
                    w,
                    key
                );
            }
        ...
        var choicesEnumerableAspect = ChoicesEnumerableAspect(
            countableChoicesList,
            function (wrap) {
                return wrap.choice.itemNext;
            }
        );
        var filteredChoicesList = DoublyLinkedList(
            function (wrap) {
        ...
        var emptyNavigateManager = NavigateManager(
            countableChoicesList,
            function (wrap) {
                return wrap.choice.itemPrev;
            },
        ...
        var filteredNavigateManager = NavigateManager(
            filteredChoicesList,
            function (wrap) {
                return wrap.choice.filteredPrev;
            },
        ...
        var filterManagerAspect = FilterManagerAspect(
            emptyNavigateManager,
            filteredNavigateManager,
            filteredChoicesList,
            choicesEnumerableAspect,
        ...
        var navigateAspect = NavigateAspect(
            hoveredChoiceAspect,
            function (down, hoveredChoice) {
                return filterManagerAspect
                    .getNavigateManager()
        ...
        var resetFilterListAspect = ResetFilterListAspect(
            filterDom,
            filterManagerAspect
        );
        var resetFilterAspect = ResetFilterAspect(
            filterDom,
            resetFilterListAspect
        );
        var focusInAspect = FocusInAspect(picksDom);
        var inputAspect = InputAspect(
            filterDom,
            filterManagerAspect
            /*, fullMatchAspect*/
        );
        var buildAndAttachChoiceAspect =
            BuildAndAttachChoiceAspect(produceChoiceAspect);
        ...
        var optionAttachAspect = OptionAttachAspect(
            createWrapAspect,
            createChoiceBaseAspect,
            buildAndAttachChoiceAspect,
            wraps
        ...
        var updateDataAspect = UpdateDataAspect(
            choicesDom,
            wraps,
            picksList,
            optionsLoopAspect,
        ...
        var choicesVisibilityAspect = ChoicesVisibilityAspect(
            choicesDom.choicesElement
        );
        var afterInputAspect = AfterInputAspect(
            filterManagerAspect,
            navigateAspect,
            choicesVisibilityAspect,
            hoveredChoiceAspect
        ...
        eventHandlers.layout(
            ...
            (_eventHandlers$layout["resetLayoutAspect"] = resetLayoutAspect),
            (_eventHandlers$layout.focusInAspect = focusInAspect),
            (_eventHandlers$layout.loadAspect = loadAspect),
            (_eventHandlers$layout.updateDataAspect = updateDataAspect),
            (_eventHandlers$layout.updateAspect = updateAspect),
            (_eventHandlers$layout.picksElementAspect = picksElementAspect),
            (_eventHandlers$layout.afterInputAspect = afterInputAspect),
            _eventHandlers$layout)
        );
            ...
            return {
                dom: function dom(newAspects) {
                    ...
                    for (var i = 0; i < doms.length; i++) {
                        ...
                        var eventHandler =
                            (_doms$i$value = (_doms$i = doms[i]).value) == null
                                ? void 0
                                : _doms$i$value.call(_doms$i);
                        parseEventHandler(
                            doms[i].key,
                            eventHandler,
                            doms,
                ...
                plugStaticDom: function plugStaticDom(newAspects) {
                    ...
                    for (var i = 0; i < plugStaticDoms.length; i++) {
                        ...
                        var eventHandler =
                            (_plugStaticDoms$i$val = (_plugStaticDoms$i =
                                plugStaticDoms[i]).value) == null
                                ? void 0
                                : _plugStaticDoms$i$val.call(_plugStaticDoms$i);
                        parseEventHandler(
                            plugStaticDoms[i].key,
                            eventHandler,
                            doms,
                            plugStaticDoms,
                            preLayouts,
                ...
                layout: function layout(newAspects) {
                    ...
                    for (var i = 0; i < preLayouts.length; i++) {
                        ...
                        var _eventHandler =
                            (_preLayouts$i$value = (_preLayouts$i =
                                preLayouts[i]).value) == null
                                ? void 0
                                : _preLayouts$i$value.call(_preLayouts$i);
                    ...
                    for (var j = 0; j < layouts.length; j++) {
                        ...
                        var _eventHandler2 =
                            (_layouts$j$value = (_layouts$j = layouts[j])
                                .value) == null
                                ? void 0
                                : _layouts$j$value.call(_layouts$j);
                ...
                append: function append() {
                    for (var i = 0; i < appends.length; i++) {
                        ...
                        var eventHandler =
                            (_appends$i$value = (_appends$i = appends[i])
                                .value) == null
                                ? void 0
                                : _appends$i$value.call(_appends$i);
                        parseEventHandler(
                            appends[i].key,
                            eventHandler,
                            doms,
                ...
                buildApi: function buildApi(api) {
                    for (var i = 0; i < buildApis.length; i++) {
                        ...
                        var eventHandler =
                            (_buildApis$i$value = (_buildApis$i = buildApis[i])
                                .value) == null
                                ? void 0
                                : _buildApis$i$value.call(_buildApis$i, api);
                        parseEventHandler(
                            buildApis[i].key,
                            eventHandler,
                            doms,
                ...
                dispose: function dispose() {
                    for (var i = 0; i < disposes.length; i++) {
                        ...
                        (_disposes$i$value = (_disposes$i = disposes[i])
                            .value) == null
                            ? void 0
                            : _disposes$i$value.call(_disposes$i);
                    }
                },
            };
        };
    ...
    function adjustLegacySettings(settings) {
        ...
        if (
            settings.selectedPanelFocusBorderColor ||
            settings.selectedPanelFocusBoxShadow
        ) {
            console.log(
    ...
    function MultiSelectBuilder(environment, plugins, defaultCss) {
        ...
        var pluginManagerFactory = ComposePluginManagerFactory(
            plugins,
            defaults,
            environment
        );
      ...
      */
        ...
        var create = function create(element, options) {
            ...
            if (options instanceof Function) {
                ...
                buildConfiguration =
                    options == null ? void 0 : options.buildConfiguration;
                settings = options;
            }
            ...
            var configuration = {};
            configuration.css = createCss(
                defaults.css,
                (_settings = settings) == null ? void 0 : _settings.css
            );
            ...
            var inlineBuildAspectsList =
                buildConfiguration == null
                    ? void 0
                    : buildConfiguration(element, configuration); // next line merges settings.cssPatch and defaults.cssPatch also merge defaults.css and defaults.cssPatch

            var pluginManager = pluginManagerFactory(
                configuration,
                settings,
                inlineBuildAspectsList
            ); // now we can freeze configuration object

            Object.freeze(configuration);
            var multiSelect = BsMultiSelect$1(
                element,
                environment,
                pluginManager,
                configuration
    ...
    function createForJQuery(
        ...
        var trigger = null;
        var isJQyery =
            $ && !window.document.body.hasAttribute("data-bs-no-jquery");
        ...
        var _MultiSelectBuilder = MultiSelectBuilder(
                environment,
                pluginsArray,
                defaultCss
            ),
        ...
        if (isJQyery) {
            var constructorForJquery = function constructorForJquery(
                element,
                settings,
                removeInstanceData
            ) {
            ...
            var prototypable = addToJQueryPrototype(
                name,
                constructorForJquery,
                $
            );
            ...
            return {
                ...
                layout: function layout() {
                    ...
                    if (floatingLabelAspect) {
                        isFloatingLabel = closestByClassName(
                            initialElement,
                            "form-floating"
                        );
                    ...
                    var getWasValidated = function getWasValidated() {
                        var wasValidatedElement = closestByClassName(
                            initialElement,
                            "was-validated"
                        );
                    ...
                    var getManualValidationObservable = ObservableLambda(
                        function () {
                            return getValidity();
                        }
                    );
                    var validationObservable = ObservableLambda(function () {
                        return wasUpdatedObservable.getValue()
                            ? validationApiAspect.getValue()
                            : getManualValidationObservable.getValue();
                    });
                    validationObservable.attach(function (value) {
                        var _getMessagesElements = getMessagesElements(
                                staticDom.containerElement
                            ),
                            validMessages = _getMessagesElements.validMessages,
                            invalidMessages =
                                _getMessagesElements.invalidMessages;
                    ...
                    if (validationApiAspect)
                        validationApiAspect.attach(function () {
                            return validationObservable.call();
                        });
    ...
    function updateSizeJsForAdapter(
        picksElement,
        picksLgStyling,
        picksSmStyling,
        picksDefStyling,
    ...
    function composeGetValidity(selectElement) {
        var getValidity = function getValidity() {
            return selectElement.classList.contains("is-invalid")
                ? false
                : selectElement.classList.contains("is-valid")
                ? true
                : null;
        };
    ...
    function composeGetSize(element) {
        ...
        if (inputGroupElement) {
            ...
            getSize = function getSize() {
                var value = null;
                if (
                    element.classList.contains("form-select-lg") ||
                    element.classList.contains("form-control-lg")
                )
                    // changed for BS
                    value = "lg";
                else if (
                    element.classList.contains("form-select-sm") ||
                    element.classList.contains("form-control-sm")
                )
                    value = "sm";
                return value;
            };
    ...
    function plug$o(configuration) {
        ...
        return function (aspects) {
            ...
            aspects.createFilterInputElementIdAspect =
                        ...
                        if (labelElement) {
                            ...
                            if (backupedForAttribute) {
                                disposeAspect.dispose = composeSync(
                                    disposeAspect.dispose,
                                    function () {
                                        return labelElement.setAttribute(
                                            "for",
                                            backupedForAttribute
                                        );
                                    }
                                );
                            }
        ...
        return function (aspects) {
            return {
                layout: function layout() {
                    ...
                    if (isBoolean(isRtl)) forceRtlOnContainer = true;
                    else isRtl = getIsRtl(staticDom.initialElement);
                    ...
                    if (forceRtlOnContainer) {
                        ...
                        var dirAttributeValue =
                            staticDom.selectElement.getAttribute("dir");
                    ...
                    if (popperRtlAspect)
                        popperRtlAspect.getIsRtl = function () {
                            return isRtl;
                        };
                    return {
                        dispose: function dispose() {
            ...
            return {
                layout: function layout() {
                    ...
                    if (staticDom.selectElement) {
                        var form = closestByTagName(
                            staticDom.selectElement,
                            "FORM"
                        );

                        if (form) {
                            eventBuilder.bind(form, "reset", function () {
                                return environment.window.setTimeout(
                                    function () {
    ...
    function plug$l(configuration) {
        ...
        var getValueRequiredAspect = GetValueRequiredAspect(
            required,
            getValueRequired
        );
        return function (aspects) {
            ...
            return {
                plugStaticDom: function plugStaticDom() {
                    var dataWrap = aspects.dataWrap,
                        staticDom = aspects.staticDom;
                    var valueMissingMessageEx = defCall(
                        valueMissingMessage,
                        function () {
                            return getDataGuardedWithPrefix(
                                staticDom.initialElement,
                                "bsmultiselect",
                    ...
                    return {
                        preLayout: function preLayout() {
                            ...
                            var isValueMissingObservable = ObservableLambda(
                                function () {
                                    return (
                                        getValueRequiredAspect.getValueRequired() &&
                                        getIsValueMissing()
                                    );
                                }
                            );
                            var validationApiObservable = ObservableValue(
                                !isValueMissingObservable.getValue()
                            );
                            aspects.validationApiAspect = ValidationApiAspect(
                                validationApiObservable
                            ); // used in BsAppearancePlugin layout, possible races

                            return {
                                layout: function layout() {
                                    var onChangeAspect = aspects.onChangeAspect,
                                        updateDataAspect =
                                            aspects.updateDataAspect; // TODO: required could be a function
                                    //let {valueMissingMessage} = configuration;

                                    onChangeAspect.onChange = composeSync(
                                        isValueMissingObservable.call,
                                        onChangeAspect.onChange
                                    );
                                    updateDataAspect.updateData = composeSync(
                                        isValueMissingObservable.call,
                                        updateDataAspect.updateData
                                    );
                                    return {
                                        buildApi: function buildApi(api) {
                                            ...
                                            api.validationApi = ValidityApi(
                                                ...
                                                function (isValid) {
                                                    return validationApiObservable.setValue(
                                                        isValid
                                                    );
                                                },
                                                staticDom.trigger
        ...
        return {
            getValueRequired: function getValueRequired() {
                ...
                if (!isBoolean(required))
                    if (getValueRequiredCfg) value = getValueRequiredCfg();
                return value;
            },
        };
    }
        ...
        return {
            ...
            setCustomValidity: function setCustomValidity(message) {
                ...
                setMessage(
                    ...
                    customValidationMessage ? true : false
                );
            },
                ...
                layout: function layout() {
                    var createWrapAspect = aspects.createWrapAspect,
                        isChoiceSelectableAspect =
                            aspects.isChoiceSelectableAspect,
                        wrapsCollection = aspects.wrapsCollection,
                        produceChoiceAspect = aspects.produceChoiceAspect,
                        buildAndAttachChoiceAspect =
                            aspects.buildAndAttachChoiceAspect,
                        countableChoicesListInsertAspect =
                            aspects.countableChoicesListInsertAspect,
                        countableChoicesList = aspects.countableChoicesList;

                    countableChoicesListInsertAspect.countableChoicesListInsert =
                        function (wrap, key) {
                            if (!wrap.isOptionHidden) {
                                var choiceNext = wrapsCollection.getNext(
                                    key,
                                    function (c) {
                    ...
                    var origBuildAndAttachChoice =
                        buildAndAttachChoiceAspect.buildAndAttachChoice;

                    buildAndAttachChoiceAspect.buildAndAttachChoice = function (
                        wrap,
                        getNextElement
                    ) {
                        if (wrap.isOptionHidden) {
                    ...
                    if (options) {
                        if (!getIsOptionHidden)
                            getIsOptionHidden = function getIsOptionHidden(
                                option
                            ) {
                    ...
                    return {
                        buildApi: function buildApi(api) {
                            var getNextNonHidden = function getNextNonHidden(
                                ...
                                return wrapsCollection.getNext(
                                    key,
                                    function (c) {
                                        return !c.isOptionHidden;
                                    }
                            ...
                            api.updateOptionsHidden = function () {
                                return wrapsCollection.forLoop(function (
                                    wrap,
                                    key
                                ) {
                                    return updateChoiceHidden(
                                        wrap,
                                        key,
                                        getNextNonHidden,
                                        countableChoicesList,
            ...
            return {
                buildApi: function buildApi(api) {
                    ...
                    api.updateOptionAdded = function (key) {
                        ...
                        var wrap = createWrapAspect.createWrap(option);
                        wrap.choice =
                            createChoiceBaseAspect.createChoiceBase(option);
                        ...
                        buildAndAttachChoiceAspect.buildAndAttachChoice(
                            ...
                            function () {
                                ...
                                return (_nextChoice = nextChoice()) == null
                                    ? void 0
                                    : _nextChoice.choice.choiceDom
                                          .choiceElement;
                            }
                        );
                    };
                    ...
                    api.updateOptionRemoved = function (key) {
                        ...
                        wrap.choice.choiceDomManagerHandlers.detach == null
                            ? void 0
                            : wrap.choice.choiceDomManagerHandlers.detach();
                ...
                layout: function layout() {
                    var staticDom = aspects.staticDom,
                        ...
                        updateOptionsSelectedAspect =
                            aspects.updateOptionsSelectedAspect;
                    var window = environment.window;
            ...
            return {
                data: function data(
                    ...
                    if (initialElement.tagName == "SELECT") {
                        ...
                        if (containerClass) {
                            staticDom.containerElement = closestByClassName(
                                selectElement,
                                containerClass
                            );
                        }
                    } else if (initialElement.tagName == "DIV") {
                        selectElement = findDirectChildByTagName(
                            initialElement,
                            "SELECT"
                        );
                ...
                dom: function dom() {
                    var staticDomFactory = aspects.staticDomFactory,
                        ...
                        disabledComponentAspect =
                            aspects.disabledComponentAspect;
                    var createElementAspect = staticDom.createElementAspect,
                        initialElement = staticDom.initialElement;
                    ...
                    staticDomFactory.createStaticDom = function () {
                        ...
                        if (!containerElement) {
                            containerElement =
                                createElementAspect.createElement("DIV");
                            containerElement.classList.add(containerClass);
                        ...
                        if (selectElement) {
                            ...
                            if (selectElement.required === true)
                                selectElement.required = false; // TODO: move to DisableCompenentPlugin
                            //let {getDisabled} = configuration;

                            if (disabledComponentAspect) {
                                var fieldsetElement = closestByTagName(
                                    selectElement,
                                    "FIELDSET"
                                );
                                var origGetDisabled =
                            ...
                            if (optGroupAspect) {
                                optGroupAspect.getOptionOptGroup = function (
                                    option
                                ) {
                                    return option.parentNode;
                                };

                                optGroupAspect.getOptGroupText = function (
                                    optGroup
                                ) {
                                    return optGroup.label;
                                };

                                optGroupAspect.getOptGroupId = function (
                                    optGroup
                                ) {
                                    return optGroup.id;
                                };
                            ...
                            if (
                                ...
                                createFilterInputElementIdAspect.createFilterInputElementId =
                                    function () {
                                        var id =
                                            origCreateFilterInputElementId();
                            ...
                            staticManager: {
                                ...
                                dispose: function dispose() {
                                    var choicesDom = staticDom.choicesDom,
                                        ...
                                        isDisposablePicksElementFlag =
                                            staticDom.isDisposablePicksElementFlag;
                                    choicesDom.choicesElement.parentNode.removeChild(
                                        choicesDom.choicesElement
                                    );
                                    if (isDisposableContainerElementFlag)
                                        selectElement.parentNode.removeChild(
                                            containerElement
                                        );
                                    if (isDisposablePicksElementFlag)
                                        containerElement.removeChild(
        ...
        return function (aspects) {
            ...
            if (options) {
                if (!setIsOptionSelected) {
                    setIsOptionSelected = function setIsOptionSelected(
                        option,
                        value
                    ) {
            ...
            return {
                ...
                layout: function layout() {
                    ...
                    var origFilterPredicate =
                        filterPredicateAspect.filterPredicate;

                    filterPredicateAspect.filterPredicate = function (
                        wrap,
                        text
                    ) {
                        return (
                            !wrap.isOptionSelected &&
                            origFilterPredicate(wrap, text)
                        );
                    };
                    ...
                    function trySetWrapSelected(
                        ...
                        //  wrap.option
                        var success = false;
                        var confirmed = setSelectedAspect.setSelected(
                            option,
                            booleanValue
                        );
                    ...
                    ExtendProduceChoiceAspectProduceChoice$1(
                        produceChoiceAspect,
                        onChangeAspect,
                        trySetWrapSelected,
                    ...
                    createWrapAspect.createWrap = function (option) {
                        var wrap = origCreateWrap(option);
                        wrap.isOptionSelected =
                            getSelectedAspect.getSelected(option);
                        wrap.updateSelected = null; // can it be combined ?

                        return wrap;
                    };

                    ExtendProducePickAspect$1(
                        producePickAspect,
                        trySetWrapSelected,
                        composeUpdateSelected
                    );
                    return {
                        buildApi: function buildApi(api) {
                            api.selectAll = function () {
                                ...
                                wrapsCollection.forLoop(function (wrap) {
                                    if (
                                        ...
                                        trySetWrapSelected(
                                            wrap.option,
                                            composeUpdateSelected(wrap, true),
                                            true
                                        );
                                });
                            };
                            ...
                            api.setOptionSelected = function (key, value) {
                                ...
                                return trySetWrapSelected(
                                    wrap.option,
                                    composeUpdateSelected(wrap, value),
                                    value
                                );
    ...
    function ExtendProduceChoiceAspectProduceChoice$1(
        produceChoiceAspect,
        onChangeAspect,
        trySetWrapSelected,
        composeUpdateSelected,
        ...
        produceChoiceAspect.produceChoice = function (wrap) {
            ...
            wrap.choice.tryToggleChoice = function () {
                return trySetWrapSelected(
                    wrap.option,
                    composeUpdateSelected(wrap, !wrap.isOptionSelected),
                    !wrap.isOptionSelected
                );
            };
    ...
    function ExtendProducePickAspect$1(
        producePickAspect,
        trySetWrapSelected,
        composeUpdateSelected
    ) {
        ...
        producePickAspect.producePick = function (wrap, pickHandlers) {
            ...
            pick.setSelectedFalse = function () {
                return trySetWrapSelected(
                    wrap.option,
                    composeUpdateSelected(wrap, false),
                    false
                );
            };
                ...
                layout: function layout() {
                    ...
                    if (options) {
                        if (!getIsOptionDisabled)
                            getIsOptionDisabled = function getIsOptionDisabled(
                                option
                            ) {
            ...
            wrap.choice.tryToggleChoice = function () {
                ...
                if (wrap.isOptionSelected !== undefined) {
                    if (wrap.isOptionSelected || !wrap.isOptionDisabled)
                        // TODO: declare dependency on SelectedOptionPlugin
    ...
    function ExtendProducePickAspectProducePick(producePickAspect) {
        ...
        producePickAspect.producePick = function (wrap) {
            ...
            wrap.updateDisabled = composeSync(
    ...
    function ExtendPickDomFactoryCreate(pickDomFactory, css) {
        ...
        pickDomFactory.create = function (pick) {
            ...
            var pickDom = pick.pickDom,
                pickDomManagerHandlers = pick.pickDomManagerHandlers;
            var disableToggle = toggleStyling(
                pickDom.pickContentElement,
                css.pickContent_disabled
            );
            ...
            return {
                buildApi: function buildApi(api) {
                    ...
                    api.getTailPeak = function () {
                        ...
                        return (_picksList$getTail = picksList.getTail()) ==
                            null
                            ? void 0
                            : _picksList$getTail.option;
                    };
    ...
    function plug$a() {
        ...
        return function (aspects) {
            ...
            if (Popper) {
                // V2
                createPopperVX = createPopper = (function (
                    createPopperConstructor
                ) {
                    return function (
                        anchorElement,
                        element,
                        ...
                        return new createPopperConstructor(
                            anchorElement,
                            element,
                            popperConfiguration
                        );
            ...
            var createPopperConfigurationAspect =
                CreatePopperConfigurationAspect(createModifiersVX);
            var createPopperAspect = CreatePopperAspect(
                createPopperVX,
                popperRtlAspect,
            ...
            return {
                append: function append() {
                    var filterDom = aspects.filterDom,
                        ...
                        choicesVisibilityAspect =
                            aspects.choicesVisibilityAspect,
                        specialPicksEventsAspect =
                            aspects.specialPicksEventsAspect;
                    var filterInputElement = filterDom.filterInputElement;
                    var choicesElement = choicesDom.choicesElement;
                    var pop = createPopperAspect.createPopper(
                        choicesElement,
                        filterInputElement,
                        true
                    );
                    staticManager.appendToContainer = composeSync(
                        staticManager.appendToContainer,
                        pop.init
                    );
                ...
                return {
                    init: function init() {
                        ...
                        var popperConfiguration =
                            createPopperConfigurationAspect.createConfiguration(
                                preventOverflow,
                                isRtl
                            );
                        popper = createPopperVX(
                            anchorElement,
                            element,
                            popperConfiguration
                        );
            ...
            return {
                layout: function layout() {
                    if (useChoicesDynamicStyling) {
                        var choicesVisibilityAspect =
                                aspects.choicesVisibilityAspect,
                            specialPicksEventsAspect =
                                aspects.specialPicksEventsAspect;
                        var origSetChoicesVisible =
                            choicesVisibilityAspect.setChoicesVisible;

                        choicesVisibilityAspect.setChoicesVisible = function (
                            visible
                        ) {
    ...
    function choicesDynamicStyling(aspects, window) {
        ...
        var choicesElement = choicesDom.choicesElement;
        var minimalChoicesDynamicStylingMaxHeight =
            configuration.minimalChoicesDynamicStylingMaxHeight; //find height of the browser window
        ...
        var msHeight = Math.max(
            minimalChoicesDynamicStylingMaxHeight,
            Math.round(new_y * 0.85)
        ); // Michalek: 0.85 is empiric value, without it list was longer than footer height ; TODO: propose better way
        ...
        if (!choicesDom.ChoicesDynamicStylingPlugin_scrollHandle) {
            ...
            navigateAspect.navigate = function (down) {
                ...
                if (
                    wrap != null &&
                    wrap.choice != null &&
                    wrap.choice.choiceDom.choiceElement != null
                )
    ...
    function ExtendChoiceDomFactory$1(choiceDomFactory, dataWrap) {
        ...
        choiceDomFactory.create = function (choice) {
            ...
            choice.choiceDomManagerHandlers.updateHighlighted = function () {
                ...
                else choiceElement.textContent = text;
            };
        };
    }
            ...
            return {
                ...
                layout: function layout() {
                    ...
                    if (highlightAspect) {
                        ...
                        var origProduceChoice =
                            produceChoiceAspect.produceChoice;

                        produceChoiceAspect.produceChoice = function (wrap) {
                            origProduceChoice(wrap);
                            var origSetVisible =
                                wrap.choice.choiceDomManagerHandlers.setVisible;
    ...
    function plug$7(configuration) {
        return function (aspects) {
            return {
                plugStaticDom: function plugStaticDom() {
                    var choiceDomFactory = aspects.choiceDomFactory;
                    var customChoiceStylings =
                        configuration.customChoiceStylings;

                    if (customChoiceStylings) {
                        var customChoiceStylingsAspect =
                            CustomChoiceStylingsAspect(customChoiceStylings);
                        ExtendChoiceDomFactory(
                            choiceDomFactory,
                            customChoiceStylingsAspect
                        );
                    }
                },
            };
    ...
    function ExtendChoiceDomFactory(
        choiceDomFactory,
        customChoiceStylingsAspect
    ) {
        var origChoiceDomFactoryCreate = choiceDomFactory.create;
        ...
        choiceDomFactory.create = function (choice) {
            origChoiceDomFactoryCreate(choice);
            customChoiceStylingsAspect.customize(
                choice.wrap,
                choice.choiceDom,
                choice.choiceDomManagerHandlers
            );
        };
    }
    ...
    function CustomChoiceStylingsAspect(customChoiceStylings) {
        return {
            customize: function customize(choice) {
                var handlers = customChoiceStylings(
                    choice.choiceDom,
                    choice.wrap.option
                );

                if (handlers) {
                    var customChoiceStylingsClosure =
                        function customChoiceStylingsClosure(custom) {
                            return function () {
                                custom({
                                    isOptionSelected:
                                        choice.wrap.isOptionSelected,
                                    isOptionDisabled:
                                        choice.wrap.isOptionDisabled,
                    ...
                    if (
                        choiceDomManagerHandlers.updateHoverIn &&
                        handlers.updateHoverIn
                    )
                        choiceDomManagerHandlers.updateHoverIn = composeSync(
                            choiceDomManagerHandlers.updateHoverIn,
                            customChoiceStylingsClosure(handlers.updateHoverIn)
                        );
                    if (
                        choiceDomManagerHandlers.updateSelected &&
                        handlers.updateSelected
                    )
                        choiceDomManagerHandlers.updateSelected = composeSync(
                            choiceDomManagerHandlers.updateSelected,
                            customChoiceStylingsClosure(handlers.updateSelected)
                        );
                    if (
                        choiceDomManagerHandlers.updateDisabled &&
                        handlers.updateDisabled
                    )
                        choiceDomManagerHandlers.updateDisabled = composeSync(
                            choiceDomManagerHandlers.updateDisabled,
                            customChoiceStylingsClosure(handlers.updateDisabled)
                        );
                    if (
                        choiceDomManagerHandlers.updateHighlighted &&
                        handlers.updateHighlighted
                    )
                        choiceDomManagerHandlers.updateHighlighted =
                            composeSync(
                                choiceDomManagerHandlers.updateHighlighted,
                                customChoiceStylingsClosure(
                                    handlers.updateHighlighted
                                )
                            );
                }
    ...
    function plug$6(configuration) {
        return function (aspects) {
            return {
                plugStaticDom: function plugStaticDom() {
                    var disabledComponentAspect =
                            aspects.disabledComponentAspect,
                        pickDomFactory = aspects.pickDomFactory;
                    var customPickStylings = configuration.customPickStylings;
                    var customPickStylingsAspect = CustomPickStylingsAspect(
                        disabledComponentAspect,
                        customPickStylings
                    );
                    ExtendPickDomFactory$2(
                        pickDomFactory,
                        customPickStylingsAspect
                    );
                },
            };
        };
    ...
    function CustomPickStylingsAspect(
        disabledComponentAspect,
        customPickStylings
    ) {
        return {
            customize: function customize(pick) {
                if (customPickStylings) {
                    var handlers = customPickStylings(
                        pick.pickDom,
                        pick.wrap.option
                    );

                    if (handlers) {
                        var customPickStylingsClosure =
                            function customPickStylingsClosure(custom) {
                                return function () {
                                    custom({
                                        isOptionDisabled:
                                            pick.wrap.isOptionDisabled,
                        ...
                        var pickDomManagerHandlers =
                            pick.pickDomManagerHandlers; // TODO: automate it

                        if (
                            pickDomManagerHandlers.updateDisabled &&
                            handlers.updateDisabled
                        )
                            pickDomManagerHandlers.updateDisabled = composeSync(
                                pickDomManagerHandlers.updateDisabled,
                                customPickStylingsClosure(
                                    handlers.updateDisabled
                                )
                            );
                        if (
                            pickDomManagerHandlers.updateComponentDisabled &&
                            handlers.updateComponentDisabled
                        )
                            pickDomManagerHandlers.updateComponentDisabled =
                                composeSync(
                                    pickDomManagerHandlers.updateComponentDisabled,
            ...
            return {
                layout: function layout() {
                    var updateAspect = aspects.updateAspect,
                        loadAspect = aspects.loadAspect;
                    updateAspect.update = composeSync(
                        updateAspect.update,
                        function () {
    ...
    function plug$4(configuration) {
        var disabledComponentAspect = DisabledComponentAspect(
        ...
        return function (aspects) {
            ...
            return {
                ...
                layout: function layout() {
                    ...
                    var disableComponent = function disableComponent(
                        isComponentDisabled
                    ) {
                        picksList.forEach(function (pick) {
                    ...
                    function updateDisabled() {
                        ...
                        var newIsComponentDisabled =
                            (_disabledComponentAsp =
                                disabledComponentAspect.getDisabled()) != null
                                ? _disabledComponentAsp
                                : false;
        ...
        pickDomFactory.create = function (pick) {
            ...
            pickDomManagerHandlers.updateComponentDisabled = function () {
                ...
                if (pickDomManagerHandlers.disableButton)
                    pickDomManagerHandlers.disableButton(
                        (_disabledComponentAsp2 =
                            disabledComponentAspect.getDisabled()) != null
                            ? _disabledComponentAsp2
                            : false
                    );
            ...
            return {
                layout: function layout() {
                    ...
                    if (isIE11) {
                        ...
                        var placeholderStopInputAspect =
                    ...
                    if (!placeholder) {
                        placeholder = getDataGuardedWithPrefix(
                            staticDom.initialElement,
                            "bsmultiselect",
                            "placeholder"
                        );
                    ...
                    function setEmptyInputWidth(isVisible) {
                        if (isVisible) filterInputElement.style.width = "100%";
                        else filterInputElement.style.width = "2ch";
                    }

                    var emptyToggleStyling = toggleStyling(
                        filterInputElement,
                        css.filterInput_empty
                    );
                    ...
                    filterManagerAspect.processEmptyInput = composeSync(
                        updateEmptyInputWidth,
                        filterManagerAspect.processEmptyInput
                    );
                    resetFilterListAspect.forceResetFilter = composeSync(
                        resetFilterListAspect.forceResetFilter,
            ...
            return {
                ...
                layout: function layout() {
                    ...
                    if (floatingLabelAspect.isFloatingLabel()) {
                        ...
                        var labelElement = getLabelAspect.getLabel();
                        var picksElement = picksDom.picksElement;
                        var liftToggleStyling1 = toggleStyling(
                            labelElement,
                            css.label_floating_lifted
                        );
                        var liftToggleStyling2 = toggleStyling(
                            picksElement,
                            css.picks_floating_lifted
                        );
            ...
            return {
                layout: function layout() {
                    ...
                    if (configuration.isNoResultsWarningEnabled) {
                        var warningAspect = WarningAspect(
                            choicesDom,
                            createElementAspect,
                            staticManager,
                            css
                ...
                append: function append() {
                    ...
                    if (warningAspect) {
                        var filterInputElement = filterDom.filterInputElement;
                        var pop2 = createPopperAspect.createPopper(
                            warningAspect.warningElement,
                            filterInputElement,
                            false
                        );
                        staticManager.appendToContainer = composeSync(
    ...
    function ExtendAfterInputAspect(
        afterInputAspect,
        warningAspect,
        filterManagerAspect,
        noResultsWarning
        ...
        afterInputAspect.notVisible = function (hideChoices) {
            ...
            else warningAspect.hide();
        };
    }

    function WarningAspect(
        choicesDom,
        createElementAspect,
        staticManager,
        css
        ...
        staticManager.appendToContainer = composeSync(
            staticManager.appendToContainer,
            function () {
                return choicesElement.parentNode.insertBefore(
                    warningElement,
                    choicesElement.nextSibling
                );
            }
        );
        ...
        return function (aspects) {
            return {
                plugStaticDom: function plugStaticDom() {
                    var pickDomFactory = aspects.pickDomFactory,
                        staticDom = aspects.staticDom;
                    ExtendPickDomFactory(
                        pickDomFactory,
                        staticDom.createElementAspect,
                        configuration.pickButtonHTML,
                        configuration.css
                    );
                },
                layout: function layout() {
    ...
    function ExtendPickDomFactory(
        ...
        pickDomFactory.create = function (pick) {
            ...
            var pickDom = pick.pickDom,
                pickDomManagerHandlers = pick.pickDomManagerHandlers;
            createElementAspect.createElementFromHtmlPutAfter(
                pickDom.pickContentElement,
                pickButtonHTML
            );
